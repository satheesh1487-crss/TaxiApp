...
namespace TaziappzMobileWebAPI.Controllers
{
    ...
    public class UserPaymentController : ControllerBase
    {
        ...
        public IActionResult HistorySingle(GeneralModel generalModel)
        {
            ...
            return this.OK<UserPaymentModel>(userPaymentModel, userPaymentModel == null ? "Preferred_Payment_Not_Found" : "Preferred_Payment_found", userPaymentModel == null ? 0 : 1);
        }
        #endregion
        ...
        public IActionResult AddWallet(GeneralModel generalModel)
        {
            ...
            return this.OK<UserAddWalletModel>(userAddWalletModel, userAddWalletModel == null ? "Add_Wallet_Not_Found" : "Add_Wallet_found", userAddWalletModel == null ? 0 : 1);
        }
        #endregion
        ...
        public IActionResult DeleteCard(GeneralModel generalModel)
        {
            ...
            return this.OK<UserDeleteCardModel>(userDeleteCardModel, userDeleteCardModel == null ? "Delete_Card_Not_Found" : "Delete_Card_found", userDeleteCardModel == null ? 0 : 1);
        }
        #endregion
        ...
        public IActionResult Getwallet(GeneralModel generalModel)
        {
            ...
            return this.OK<UserGetWalletModel>(userGetWalletModel, userGetWalletModel == null ? "Get_Wallet_Not_Found" : "Get_Wallet_found", userGetWalletModel == null ? 0 : 1);
        }
        #endregion
        ...
        public IActionResult Cardlist(GeneralModel generalModel)
        {
            ...
            return this.OK<UserCardListModel>(userCardListModel, userCardListModel == null ? "Card_List_Not_Found" : "Card_List_found", userCardListModel == null ? 0 : 1);
        }
        #endregion
        ...
        public IActionResult Client_Token(GeneralModel generalModel)
        {
            ...
            return this.OK<UserClientTokenModel>(userClientTokenModel, userClientTokenModel == null ? "Card_List_Not_Found" : "Card_List_found", userClientTokenModel == null ? 0 : 1);
        }
        #endregion
    }
}
